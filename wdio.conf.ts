...
export const config: Options.Testrunner = {
    ...
    capabilities: [{
        ...
        'appium:deviceName': 'nightwatch-android-11', // or "iPhone Simulator"
        ...
        'appium:noReset': true // This will make the app to not be uninstalled and installed every time the tests are run
    }],
    //
    // ===================
    // Test Configurations
    ...
    cucumberOpts: {
        ...
        require: ['./features/step-definitions/androidTest.ts'],
